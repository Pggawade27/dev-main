    ...
    <div style={{}}>
      <Row>
        <Col className='d-flex justify-content-center'>
          <div className='mt-5' style={{width: "21rem", position: "relative"}}>
            ...
            <div className='section2-heading' style={{marginTop: "2.2rem", marginLeft: "2rem"}}>
              <h1><span style={{fontSize: "3rem", fontWeight: "700"}}>Why build</span> <span style={{fontSize: "2.5rem", fontWeight: "500"}}>on</span> <span style={{fontSize: "3rem", fontWeight: "700"}}>XIRCLS ?</span></h1>
            </div>
            <div style={{marginLeft: "2rem"}} className='section2-info'>
              <p  style={{textAlign: "left"}}>We empower you to leverage our 100+ brand network
